    ...
    <div class="container p-5">
        <div class="row">
            ...
            <div class="col-md-5 mt-5">
                ...
                <form action="{{route('frontend.check.otp')}}" method="POST">
                    @csrf
                    <div>
                        ...
                        <p class="text-muted text-center">We've sent a code to {{$customerEmail}}</p>
                        <div class="row pt-4 pb-2">
                            <div class="col">
                                <input type="hidden" name="customerEmail" value="{{$customerEmail}}">
                            </div>
                            <div class="col">
                                <input class="otp-letter-input" type="text" name="otp">
                            </div>
                        </div>
