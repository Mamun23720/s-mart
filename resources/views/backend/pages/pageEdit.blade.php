...
<div style="margin-top: 5%;" class="row">
    ...
    <div class="col-md-4">
        ...
        <div style="border: solid #007bff;" class="form-container">
            ...
            <form action="{{ route('backend.page.update' , $page->id) }}" id="categoryForm" enctype="multipart/form-data" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input value="{{$page->page_description}}" style="border: 1px solid black;" type="text" name="pageDescription">
                </div>
